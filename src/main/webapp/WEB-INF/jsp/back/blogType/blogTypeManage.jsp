...
<div id="tb">
    <div>
        <a href="javascript:blogType.Tool.openBlogTypeAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
        <a href="javascript:blogType.Tool.openBlogTypeModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
        <a href="javascript:blogType.Tool.deleteBlogType()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
    </div>
</div>
...
<div id="dlg-buttons">
    <a href="javascript:blogType.Tool.saveBlogType()" class="easyui-linkbutton" iconCls="icon-ok">保存</a>
    <a href="javascript:blogType.Tool.closeBlogTypeDialog()" class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/back/js/blogType.js"></script>
</body>
</html>