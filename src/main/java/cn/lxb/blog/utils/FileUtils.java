...
public class FileUtils extends org.apache.commons.io.FileUtils {
    ...
    public static boolean unZipFiles(String zipFileName, String descFileName) {
        ...
        try {
            ...
            logger.info("》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》文件解压失败：" + e.getMessage());
            return false;
        }
    }
    ...
    public static String downFile(File file, HttpServletRequest request, HttpServletResponse response, String fileName) {
        ...
        if (pastLength != 0) {
            ...
            switch (rangeSwitch) {
                case 1: {
                    ...
                    contentRange.append("bytes ").append(pastLength).append("-");
                    contentRange.append(fileLength - 1).append("/").append(fileLength);
                    response.setHeader("Content-Range", contentRange.toString());
                    break;
                }
                case 2: { // 针对 bytes=27000-39000 的请求
                    StringBuilder contentRange = new StringBuilder(rangeBytes);
        ...
        try {
            response.addHeader("Content-Disposition", "attachment; filename=\"" +
                    Encodes.urlEncode(StringUtil.isBlank(fileName) ? file.getName() : fileName) + "\"");
